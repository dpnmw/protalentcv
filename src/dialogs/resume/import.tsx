  ...
  return (
    <DialogContent {...blockEvents}>
      <DialogHeader>
        ...
        <DialogDescription>
          <Trans>
            Continue where you left off by importing an existing resume you created using ProTalent CV or any another
            resume builder. Supported formats include PDF, Microsoft Word, as well as JSON files from ProTalent CV.
          </Trans>
        </DialogDescription>
      </DialogHeader>
                ...
                <FormControl
                  render={
                    <Combobox
                      ...
                      options={[
                        { value: "reactive-resume-json", label: "ProTalent CV (JSON)" },
                        { value: "reactive-resume-v4-json", label: "ProTalent CV v4 (JSON)" },
