...
const getAuthConfig = () => {
  ...
  return betterAuth({
    ...
    emailAndPassword: {
      ...
      sendResetPassword: async ({ user, url }) => {
        await sendEmail({
          ...
          text: `You requested a password reset for your ${branding.appName} account.\n\nTo reset your password, please visit the following URL:\n${url}.\n\nIf you did not request a password reset, please ignore this email.`,
        });
      },
      password: {
    ...
    emailVerification: {
      ...
      sendVerificationEmail: async ({ user, url }) => {
        await sendEmail({
          ...
          text: `You recently signed up for an account on ${branding.appName}.\n\nTo verify your email, please visit the following URL:\n${url}`,
        });
      },
    },
      ...
      changeEmail: {
        ...
        sendChangeEmailConfirmation: async ({ user, newEmail, url }) => {
          await sendEmail({
            ...
            text: `You recently requested to change your email on ${branding.appName} from ${user.email} to ${newEmail}.\n\nTo verify this change, please visit the following URL:\n${url}\n\nIf you did not request this change, please ignore this email.`,
          });
        },
      },
      additionalFields: {
    ...
    plugins: [
      ...
      twoFactor({ issuer: branding.twoFactorIssuer }),
