...
export const env = createEnv({
  ...
  server: {
    ...
    // Plan Limits
    FREE_RESUME_LIMIT: z.coerce.number().int().min(1).default(3),
    FREE_SHARING_DAYS: z.coerce.number().int().min(1).default(30),
    FLAG_ENABLE_PAID_PLAN: z.stringbool().default(false),
    UPGRADE_URL: z.url({ protocol: /https?/ }).optional(),
