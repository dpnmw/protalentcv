const templateCards = [
  { name: "Monet", tag: "Modern", bg: "#DBEAFE", line: "#BFDBFE", acc: "#93C5FD" },
  { name: "Renoir", tag: "Minimal", bg: "#F0F9FF", line: "#E0F2FE", acc: "#7DD3FC" },
  { name: "Degas", tag: "Clean", bg: "#F0FDF4", line: "#DCFCE7", acc: "#86EFAC" },
  { name: "Pissarro", tag: "Classic", bg: "#FFFBEB", line: "#FEF3C7", acc: "#FCD34D" },
  { name: "Sisley", tag: "Bold", bg: "#EDE9FE", line: "#DDD6FE", acc: "#A78BFA" },
  { name: "Cassatt", tag: "Creative", bg: "#FDF2F8", line: "#FCE7F3", acc: "#F9A8D4" },
  { name: "Morisot", tag: "Structured", bg: "#EFF6FF", line: "#DBEAFE", acc: "#60A5FA" },
  { name: "Cézanne", tag: "Compact", bg: "#F0F4FF", line: "#E0E7FF", acc: "#A5B4FC" },
  { name: "Seurat", tag: "Elegant", bg: "#F0FDFA", line: "#CCFBF1", acc: "#5EEAD4" },
  { name: "Guillaumin", tag: "Professional", bg: "#EFF6FF", line: "#DBEAFE", acc: "#3B82F6" },
  { name: "Bazille", tag: "Dark", bg: "#1F2937", line: "#374151", acc: "#6B7280" },
  { name: "Fantin", tag: "Friendly", bg: "#FFFBEB", line: "#FEF3C7", acc: "#FBBF24" },
  { name: "Signac", tag: "Executive", bg: "#F8FAFC", line: "#E2E8F0", acc: "#94A3B8" },
];
