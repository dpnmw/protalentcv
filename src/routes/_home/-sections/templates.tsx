const templateCards = [
  { name: "Roseau", tag: "Modern", bg: "#DBEAFE", line: "#BFDBFE", acc: "#93C5FD" },
  { name: "Bridgetown", tag: "Minimal", bg: "#F0F9FF", line: "#E0F2FE", acc: "#7DD3FC" },
  { name: "Castries", tag: "Clean", bg: "#F0FDF4", line: "#DCFCE7", acc: "#86EFAC" },
  { name: "Port of Spain", tag: "Classic", bg: "#FFFBEB", line: "#FEF3C7", acc: "#FCD34D" },
  { name: "Nassau", tag: "Bold", bg: "#EDE9FE", line: "#DDD6FE", acc: "#A78BFA" },
  { name: "Kingston", tag: "Creative", bg: "#FDF2F8", line: "#FCE7F3", acc: "#F9A8D4" },
  { name: "Basseterre", tag: "Structured", bg: "#EFF6FF", line: "#DBEAFE", acc: "#60A5FA" },
  { name: "St George's", tag: "Compact", bg: "#F0F4FF", line: "#E0E7FF", acc: "#A5B4FC" },
  { name: "Kingstown", tag: "Elegant", bg: "#F0FDFA", line: "#CCFBF1", acc: "#5EEAD4" },
  { name: "St John's", tag: "Professional", bg: "#EFF6FF", line: "#DBEAFE", acc: "#3B82F6" },
  { name: "Havana", tag: "Dark", bg: "#1F2937", line: "#374151", acc: "#6B7280" },
  { name: "Plymouth", tag: "Friendly", bg: "#FFFBEB", line: "#FEF3C7", acc: "#FBBF24" },
  { name: "Oranjestad", tag: "Executive", bg: "#F8FAFC", line: "#E2E8F0", acc: "#94A3B8" },
];
