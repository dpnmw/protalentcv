...
function createMcpServer() {
  const appUrl = process.env.APP_URL ?? "https://protalent.cv";
  ...
  const server = new McpServer({
    ...
    websiteUrl: appUrl,
    description:
      "ProTalent CV is a free CV and resume builder. Use this MCP server to interact with your resume using an LLM of your choice.",
    icons: [
      {
        src: `${appUrl}/icon/light.svg`,
        mimeType: "image/svg+xml",
        theme: "light",
      },
      {
        src: `${appUrl}/icon/dark.svg`,
        mimeType: "image/svg+xml",
        theme: "dark",
      },
    ],
